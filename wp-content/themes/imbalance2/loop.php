...
<?php while ( have_posts() ) : the_post(); ?>
	...
	<div class="box">
		<div class="rel">
			<?php
			if (in_category('rete') || in_category('appuntamenti')):
				$url = get_field('fonti');
				$url = (string)$url[1];
				$target="_blank";
			else:
...
<?php
//mostrare l'excerpt solo se il post non è delle categorie rete e appuntamenti.
		the_excerpt() ;
		...
		?>
			<div class="posted">
				<?php
					if (!in_category('rete')):
						imbalance2_posted_on();
						echo comments_popup_link( __( '', 'imbalance2' ), __( $separator.'One Comment', 'imbalance2' ), __( $separator.'% Comments', 'imbalance2' ) );
