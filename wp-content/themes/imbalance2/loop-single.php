				...
				<table id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
					<tr>
						...
						<td class="entry-content-right">
							<?php the_content(); ?>
							<div id="fonti">
							<h3 style="margin-bottom:0px">Fonti</h3>
							<ul>
							<?php 
$fonti = get_field('fonti');
 
  foreach($fonti as $fonte): ?>
     <li><a href='<?php echo $fonte ?>' target="_blank"><?php echo $fonte ?></a></li>
  <?php
	endforeach;
?>
</div><!--#fonti-->
...
<br/>
							...
							<div id="facebook-container">
								...
								<fb:like href="<?php echo 'http://'.$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI'] ?>" send="false" width="450" show_faces="false" font="" data-action="recommend"></fb:like>
							</div>
	...
	<?php if ($imbalance2_theme_options['images_only'] == 0): ?>
		...
		<?php the_excerpt() ?>
			<div class="posted"><?php imbalance2_posted_on() ?> <span class="main_separator"></span>
				<?php echo comments_popup_link( __( '', 'imbalance2' ), __( '/ One Comment', 'imbalance2' ), __( '/ % Comments', 'imbalance2' ) ); ?>
			</div>
	<?php endif ?>
			<div class="texts">
